    ...
    posts: [
      {
        ...
        platform: "linkedin",
        content:
          "Professional insights from a business book that every entrepreneur should read.",
...
describe("ContentManager", () => {
  ...
  it("expands and collapses variations", async () => {
    ...
    // Initially collapsed
    expect(
      screen.queryByText("Great quote from an amazing book!")
    ...
    // Now expanded
    expect(
      screen.getByText("Great quote from an amazing book!")
    ).toBeInTheDocument()
    expect(
      screen.getByText("This book changed my perspective on life")
    ).toBeInTheDocument()
  ...
  it("enables editing mode for posts", async () => {
    ...
    expect(
      screen.getByDisplayValue("Great quote from an amazing book!")
    ).toBeInTheDocument()
  ...
  it("shows platform indicators for each variation", () => {
    ...
    const secondVariation = screen
      .getByText("Business Strategy")
      .closest(".border")
  ...
  it("shows empty state when no variations match filters", async () => {
    ...
    expect(
      screen.getByText("No content variations found matching your filters.")
    ).toBeInTheDocument()
    expect(
