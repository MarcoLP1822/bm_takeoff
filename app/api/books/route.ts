...
import { z } from 'zod'
import { getOptimizedBookLibrary, BookLibraryFilters } from '@/lib/database-optimization'
...
const querySchema = z.object({
  ...
  analysisStatus: z.enum(['pending', 'processing', 'completed', 'failed']).nullable().optional(),
  sortBy: z.enum(['title', 'author', 'createdAt', 'updatedAt']).nullable().optional().default('createdAt'),
