...
export const generatedContentData: InsertGeneratedContent[] = [
  {
    ...
    platform: "twitter",
    contentType: "post",
    content: "🧠 'All warfare is based on deception' - Sun Tzu reminds us that strategy isn't just about force, but about intelligence and misdirection. How do you apply strategic thinking in your daily life? #Strategy #Leadership #ArtOfWar",
    hashtags: ["#Strategy", "#Leadership", "#ArtOfWar", "#SunTzu", "#Philosophy"],
    status: "draft"
  },
  {
    bookId: "book_id_1",
