...
export function HeroSectionClient({ translations }: HeroSectionClientProps) {
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        >
          ...
          >
            ...
            <span className="inline">{translations.badge}</span>
        ...
        >
          {[
            translations.trustIndicators.modernTech,
            translations.trustIndicators.productionReady,
            translations.trustIndicators.continuousUpdates
          ].map((text, i) => (
            <motion.div
              key={text}
