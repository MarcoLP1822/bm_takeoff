...
interface CompaniesSectionClientProps {
  translations: {
    title: string
    subtitle: string
    stats: {
...
export function CompaniesSectionClient({ translations }: CompaniesSectionClientProps) {
  const stats = [
    { label: translations.stats.githubStars, value: "500+" },
    { label: translations.stats.activeProjects, value: "1000+" },
    { label: translations.stats.contributors, value: "50+" }
  ]
