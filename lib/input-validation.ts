...
export class InputValidator {
   ...
   */
  static validateString(input: unknown, rules: ValidationRule = {}): ValidationResult {
    const errors: string[] = []
   ...
   */
  static validateSocialContent(content: string, platform: string): ValidationResult {
    const errors: string[] = []
    ...
    if (metadata.title) {
      const titleResult = this.validateString(metadata.title, {
        ...
        customValidator: (value) => {
          ...
          return this.containsSuspiciousContent(stringValue) ? 'Content contains potentially harmful elements' : true
        }
      })
   ...
   */
  static validateApiRequest(body: Record<string, unknown>, schema: Record<string, ValidationRule>): ValidationResult {
    const errors: string[] = []
