...
interface FeaturesSectionClientProps {
  translations: {
    ...
    features: {
      ...
      typescript: { title: string; description: string }
      analytics: { title: string; description: string }
    }
  }
}

export function FeaturesSectionClient({ translations }: FeaturesSectionClientProps) {
  const features = [
    {
      name: translations.features.authentication.title,
      description: translations.features.authentication.description,
      icon: Shield
    },
    {
      name: translations.features.payments.title,
      description: translations.features.payments.description,
      icon: CreditCard
    },
    {
      name: translations.features.database.title,
      description: translations.features.database.description,
      icon: Database
    },
    {
      name: translations.features.ui.title,
      description: translations.features.ui.description,
      icon: Palette
    },
    {
      name: translations.features.typescript.title,
      description: translations.features.typescript.description,
      icon: Code2
    },
    {
      name: translations.features.analytics.title,
